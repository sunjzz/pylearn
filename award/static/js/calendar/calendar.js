...
Calendar.dayMouseDown = function (ev) {
    ...
    if (el.navtype == -1 || el.navtype == 1) {
        ...
        cal.timeout =
            setTimeout((el.navtype > 0) ? "Calendar.showYearsCombo(true)" : "Calendar.showYearsCombo(false)", 250);
    } else {
        cal.timeout = null;
    }
    return Calendar.stopEvent(ev);
...
function showCalendar(id, format, informerElement, closeHandler) {
    ...
    // to the button.
    var informerType = typeof(informerElement);
    if (informerType == "string") {
        informerElement = document.getElementById(informerElement);
    }
    _dynarch_popupCalendar.showAtElement(informerElement, "Br");
    // show the calendar
