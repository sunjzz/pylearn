...
// Unicode is the answer to a normal internationalized world.  Also please
...
Calendar._TT["ABOUT"] =
    ...
    "- Utiliser les bouttons " + String.fromCharCode(0x2039) + ", " + String.fromCharCode(0x203a) +
    " pour selectionner les mois\n" +
